...
export const metadata: Metadata = {
  title: "Пузата Хата - Справжня Українська Кухня | Ресторан",
  description: "Найкращий український ресторан з традиційними стравами: борщ, вареники, котлета по-київськи. Затишна атмосфера, сімейні рецепти, помірні ціни.",
  keywords: "український ресторан, борщ, вареники, котлета по-київськи, традиційна кухня, київ, українська їжа",
  metadataBase: new URL("https://puzata-hata.ua"),
  alternates: {
    canonical: "https://puzata-hata.ua"
  },
  openGraph: {
    title: "Пузата Хата - Справжня Українська Кухня",
    description: "Найкращий український ресторан з традиційними стравами та затишною атмосферою",
    url: "https://puzata-hata.ua",
    siteName: "Пузата Хата",
    images: [
      {
        url: "https://pixabay.com/get/gd732bee7c0dd9b6f83dff718813f701e5aeb448c06aae3ea3b3f20c50db8a803f78137d853bf2feaa9915f4f5c864a17a4eef8bbb7964b0094037e7f9feb5755_1280.jpg",
        alt: "Інтер'єр ресторану Пузата Хата"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Пузата Хата - Справжня Українська Кухня",
    description: "Найкращий український ресторан з традиційними стравами та затишною атмосферою",
    images: ["https://pixabay.com/get/gd732bee7c0dd9b6f83dff718813f701e5aeb448c06aae3ea3b3f20c50db8a803f78137d853bf2feaa9915f4f5c864a17a4eef8bbb7964b0094037e7f9feb5755_1280.jpg"]
  },
  robots: {
    index: true,
    follow: true
